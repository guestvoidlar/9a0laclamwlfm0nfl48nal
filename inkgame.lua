...
RedLightMainBox:AddButton("Finish RDGL", function()
    ...
    hrp.CFrame = CFrame.new(Vector3.new(-215.82, 1023.05, 145.96))
end)
...
-- Glass Bridge (İstediğin Yeni Düzenleme Tamamen Buraya Eklendi)
                ...
                for _, v in pairs(workspace:GetDescendants()) do
                    if v:IsA("BasePart") and v.Name:lower() == "glasspart" then
                        ...
                        if isFake and not v:FindFirstChild("AntiFallPlatform") then
                            ...
                            plate.Size = v.Size
                            plate.CFrame = v.CFrame + Vector3.new(0, 0.6, 0) -- Güvenli basma mesafesi (0.6) korundu
